...
describe('Testes de Integração', function () {
    ...
    describe('GET /api/users/all', function () {
        it('Deve retornar um Array com todos os Usuarios', function (done) {
            helpers_1.request(helpers_1.app)
                .get('/api/users/all')
    ...
    describe('GET /api/users/:id', function () {
        it('Deve retornar um Array com apenas um Usuario', function (done) {
            helpers_1.request(helpers_1.app)
    ...
    describe('POST /api/users/create', function () {
        it('Deve criar um novo Usuario', function (done) {
            var user = {
                id: 2,
                name: 'Usuario Teste',
    ...
    describe('DELETE /api/users/:id/destroy', function () {
        it('Deve remover um Usuario', function (done) {
            helpers_1.request(helpers_1.app)
